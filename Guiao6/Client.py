...
def verifySignature(vsign,public_key_file_server_serial,gyxx):
    public_key_file_server_serial.verify(
        vsign,
        gyxx,
        padding.PSS(
            mgf=padding.MGF1(hashes.SHA256()),
            ...
            if msg:
                ...
                if (msg[:1]==b'P'):
                    ...
                    peer_key2 = peerPublicNumbers2.public_key(default_backend())
                                        ...
                                        #le chave privada ficheiro do cliente
                    ...
                    signature = private_key_file_cliente_serial.sign(
                    gyxx,
                    padding.PSS(
                            mgf=padding.MGF1(hashes.SHA256()),
                            salt_length=padding.PSS.MAX_LENGTH
                    ...
                    tmp = b'S'+ signature + public_key_cliente_dh_2
                    #VER SE MANTENHO
                    ...
                    return tmp
                                    #finito
                                        #reopen
                if (msg[:1] == b'm'):
                                    #- Recebe Assinatura da concatenação
                    vsign = msg[1:]
                                    #- Verifica Assinatura com pub_serv
                    verifySignature(vsign,public_key_file_server_serial,gyxx)
